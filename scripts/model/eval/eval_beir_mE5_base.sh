#!/bin/bash -i
#SBATCH --job-name=eval_beir_mE5_base
#SBATCH --output=logs/slurm/eval_beir_mE5_base_%j.out
#SBATCH --error=logs/slurm/eval_beir_mE5_base_%j.err
...
# Discovers all BEIR corpus directories under outputs/translation/runs/
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_mE5_base.csv"
