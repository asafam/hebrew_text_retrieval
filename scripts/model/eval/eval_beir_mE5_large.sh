#!/bin/bash -i
#SBATCH --job-name=eval_beir_mE5_large
#SBATCH --output=logs/slurm/eval_beir_mE5_large_%j.out
#SBATCH --error=logs/slurm/eval_beir_mE5_large_%j.err
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_mE5_large.csv"
