#!/bin/bash -i
#SBATCH --job-name=eval_beir_hmbdual
#SBATCH --output=logs/slurm/eval_beir_hebmodernbert_dualenc_%j.out
#SBATCH --error=logs/slurm/eval_beir_hebmodernbert_dualenc_%j.err
...
MODEL="outputs/archive/models/dual_encoder/cls_pooling/heq/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
LABEL="hebmodernbert-dualenc-heq"
BATCH_SIZE=256
MAX_LENGTH=512
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_hebmodernbert_dualenc.csv"
