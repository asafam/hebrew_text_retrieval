#!/bin/bash -i
#SBATCH --job-name=eval_beir_hmbsbert
#SBATCH --output=logs/slurm/eval_beir_hebmodernbert_sbert_%j.out
#SBATCH --error=logs/slurm/eval_beir_hebmodernbert_sbert_%j.err
...
MODEL="outputs/archive/models/sbert/sbert-hebmodernbert-hebnli/ckpt_20250603_1331_ep5-ba708253"
LABEL="hebmodernbert-sbert-hebnli"
BATCH_SIZE=256
MAX_LENGTH=512
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_hebmodernbert_sbert.csv"
