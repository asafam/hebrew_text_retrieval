#!/bin/bash -i
#SBATCH --job-name=eval_hmb_v2_dualenc
#SBATCH --output=logs/slurm/eval_hmb_v2_dualenc_%j.out
#SBATCH --error=logs/slurm/eval_hmb_v2_dualenc_%j.err
...
MODEL="outputs/models/dual_encoder/cls_pooling/beir_hebrew/hebmodernbert/ModernBERT-Hebrew-base_v2_lr5e6_ep10/model"
LABEL="hebmodernbert-dualenc-beir-v2"
BATCH_SIZE=256
MAX_LENGTH=512
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_hmb_v2.csv"
