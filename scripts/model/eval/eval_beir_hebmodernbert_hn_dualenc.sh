#!/bin/bash -i
#SBATCH --job-name=eval_hmb_hn_dualenc
#SBATCH --output=logs/slurm/eval_hmb_hn_dualenc_%j.out
#SBATCH --error=logs/slurm/eval_hmb_hn_dualenc_%j.err
...
MODEL="outputs/models/dual_encoder/cls_pooling/beir_hebrew_hn/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
LABEL="hebmodernbert-dualenc-beir-hn"
BATCH_SIZE=256
MAX_LENGTH=512
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_hmb_hn.csv"
