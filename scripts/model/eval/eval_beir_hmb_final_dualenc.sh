#!/bin/bash -i
#SBATCH --job-name=eval_hmb_final
#SBATCH --output=logs/slurm/eval_hmb_final_%j.out
#SBATCH --error=logs/slurm/eval_hmb_final_%j.err
...
MODEL="outputs/models/dual_encoder/cls_pooling/beir_hebrew_hn/hebmodernbert/HebrewModernBERT-base-final/model"
LABEL="hebrewmodernbert-base-final-cls"
BATCH_SIZE=256
MAX_LENGTH=512
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_hmb_final.csv"
