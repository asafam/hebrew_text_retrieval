#!/bin/bash -i
#SBATCH --job-name=eval_beir_neodictabert
#SBATCH --output=logs/slurm/eval_beir_neodictabert_%j.out
#SBATCH --error=logs/slurm/eval_beir_neodictabert_%j.err
...
python src/model/eval/collect_beir_results.py \
    ...
    --output_csv "${RESULTS_DIR}/summary_neodictabert.csv"
