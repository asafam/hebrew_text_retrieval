...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq/dicta-il_dictabert/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_long_contexts/dicta-il_dictabert/model/doc_embeddings_2048.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/dicta-il_dictabert/model/results_2048.txt"
