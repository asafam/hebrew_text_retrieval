...
BATCH_SIZE=1024
MAX_LENGTH=512
DOCUMENTS_EMBEDDING_FILE="outputs/eval/dual_encoder/heq_long_contexts/dicta-il_dictabert/model_untrained/doc_embeddings.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/dicta-il_dictabert/model_untrained/results.txt"
