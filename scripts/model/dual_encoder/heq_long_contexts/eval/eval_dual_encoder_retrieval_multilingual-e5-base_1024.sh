...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_long_contexts/intfloat_multilingual-e5-base/model/doc_embeddings_1024.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/intfloat_multilingual-e5-base/model/results_1024.txt"
