...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq/onlplab_alephbert-base/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_long_contexts/onlplab_alephbert-base/model/doc_embeddings_2048.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/onlplab_alephbert-base/model/results_2048.txt"
...
echo "Query field: $QUERY_TEXT_FIELD"
