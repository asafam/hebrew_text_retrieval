...
BATCH_SIZE=64
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_long_contexts/hebmodernbert/model_untrained/doc_embeddings_512.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/hebmodernbert/model_untrained/results_512.txt"
