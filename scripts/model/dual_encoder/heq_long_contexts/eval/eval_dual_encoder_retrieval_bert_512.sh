...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq/bert-based-uncased/model"
...
BATCH_SIZE=64
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_long_contexts/bert-base-uncased/model/doc_embeddings_512.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_long_contexts/bert-base-uncased/model/results_512.txt"
