...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq/dicta-il_neodictabert/model"
...
BATCH_SIZE=1024
MAX_LENGTH=4096
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/dual_encoder_infonce_heq/dicta-il_neodictabert/model"
OUTPUT_FILE="outputs/eval/dual_encoder/dual_encoder_infonce_heq/dicta-il_neodictabert/model/results.txt"
PRETRAIN="True"
