...
# Define variables
MODEL_PATH="/home/nlp/achimoa/workspace/hebrew_text_retrieval/outputs/models/dual_encoder/heq/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
...
BATCH_SIZE=128
MAX_LENGTH=1024
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq/hebmodernbert/ModernBERT-Hebrew-base_v2/model/results.txt"
PRETRAIN="True"
