...
# Define variables
MODEL_PATH="/home/nlp/achimoa/workspace/hebrew_text_retrieval/outputs/models/dual_encoder/heq_q_heb_d_eng/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
...
BATCH_SIZE=64
MAX_LENGTH=8192
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_heb_d_eng/hebmodernbert/ModernBERT-Hebrew-base_v2/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_heb_d_eng/hebmodernbert/ModernBERT-Hebrew-base_v2/model/results.txt"
PRETRAIN="True"
QUERY_TEXT_FIELD="question_hebrew"
QUERY_CONTEXT_FIELD="context_english"
