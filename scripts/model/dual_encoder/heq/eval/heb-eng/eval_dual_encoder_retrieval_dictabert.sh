...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq_q_heb_d_eng/dicta-il_dictabert/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_heb_d_eng/dicta-il_dictabert/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_heb_d_eng/dicta-il_dictabert/model/results.txt"
PRETRAIN="True"
