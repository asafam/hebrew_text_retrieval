...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq_q_heb_d_eng/intfloat_multilingual-e5-base/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_heb_d_eng/intfloat_multilingual-e5-base/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_heb_d_eng/intfloat_multilingual-e5-base/model/results.txt"
PRETRAIN="True"
