...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq_q_heb_d_eng/dicta-il_neodictabert/model"
TOKENIZER_PATH="dicta-il/neodictabert"
QUERIES_PATH="data/retrieval/heq/test/queries_hebrew.jsonl"
DOCUMENTS_PATH="data/retrieval/heq/test/documents_english.jsonl"
BATCH_SIZE=1024
MAX_LENGTH=4096
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_heb_d_eng/dicta-il_neodictabert/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_heb_d_eng/dicta-il_neodictabert/model/results.txt"
PRETRAIN="True"
