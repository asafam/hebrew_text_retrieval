...
# Define variables
MODEL_PATH="dicta-il/neodictabert"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq/dicta-il_neodictabert/model_untrained"
OUTPUT_FILE="outputs/eval/dual_encoder/heq/dicta-il_neodictabert/model_untrained/results.txt"
