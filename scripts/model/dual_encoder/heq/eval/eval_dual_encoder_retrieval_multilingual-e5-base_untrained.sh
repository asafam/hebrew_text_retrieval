...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq/intfloat_multilingual-e5-base/model_untrained"
OUTPUT_FILE="outputs/eval/dual_encoder/heq/intfloat_multilingual-e5-base/model_untrained/results.txt"
