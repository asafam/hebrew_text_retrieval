...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/heq_q_eng_d_heb/intfloat_multilingual-e5-large/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_eng_d_heb/intfloat_multilingual-e5-large/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_eng_d_heb/intfloat_multilingual-e5-large/model/results.txt"
PRETRAIN="True"
