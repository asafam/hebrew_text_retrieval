...
BATCH_SIZE=1024
MAX_LENGTH=4096
EMBEDDING_FILES_PATH="outputs/eval/dual_encoder/heq_q_eng_d_heb/dicta-il_neodictabert/model"
OUTPUT_FILE="outputs/eval/dual_encoder/heq_q_eng_d_heb/dicta-il_neodictabert/model/results.txt"
PRETRAIN="True"
