#!/bin/bash -i
#SBATCH --job-name=train_dualenc_hmb_v2
#SBATCH --output=logs/slurm/train_dualenc_hmb_v2_%j.out
#SBATCH --error=logs/slurm/train_dualenc_hmb_v2_%j.err
...
OUTPUT_DIR="outputs/models/dual_encoder/cls_pooling/beir_hebrew/hebmodernbert/ModernBERT-Hebrew-base_v2_lr5e6_ep10"

echo "Model: $MODEL"
echo "LR: 5e-6 | Epochs: 10 | Warmup: 10% | Scheduler: cosine"
