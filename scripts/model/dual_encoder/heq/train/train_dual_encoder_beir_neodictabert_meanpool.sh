#!/bin/bash -i
#SBATCH --job-name=train_ndb_meanpool
#SBATCH --output=logs/slurm/train_ndb_meanpool_%j.out
#SBATCH --error=logs/slurm/train_ndb_meanpool_%j.err
...
OUTPUT_DIR="outputs/models/dual_encoder/mean_pooling/beir_hebrew/neodictabert/dicta-il_NeoDictaBERT"

echo "Model: $MODEL — MEAN POOLING (A/B vs CLS best NDB 0.336)"

# Identical to best NDB recipe EXCEPT --pooling mean
