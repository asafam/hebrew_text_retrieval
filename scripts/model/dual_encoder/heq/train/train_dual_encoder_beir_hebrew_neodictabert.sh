#!/bin/bash -i
#SBATCH --job-name=train_dualenc_ndb_beir
#SBATCH --output=logs/slurm/train_dualenc_ndb_beir_%j.out
#SBATCH --error=logs/slurm/train_dualenc_ndb_beir_%j.err
...
OUTPUT_DIR="outputs/models/dual_encoder/cls_pooling/beir_hebrew/neodictabert/dicta-il_NeoDictaBERT"
