#!/bin/bash -i
#SBATCH --job-name=train_hmb_final
#SBATCH --output=logs/slurm/train_hmb_final_%j.out
#SBATCH --error=logs/slurm/train_hmb_final_%j.err
...
OUTPUT_DIR="outputs/models/dual_encoder/cls_pooling/beir_hebrew_hn/hebmodernbert/HebrewModernBERT-base-final"

echo "Model: $MODEL"
echo "Output: $OUTPUT_DIR"
echo "Recipe: lr=2e-5, hard negatives, cosine, warmup=0.05, pooling=cls, 10 epochs"
