#!/bin/bash -i
#SBATCH --job-name=dualenc_hebmodernbertv2
#SBATCH --output=logs/slurm/dualenc_hebmodernbertv2_%j.out
#SBATCH --error=logs/slurm/dualenc_hebmodernbertv2_%j.err
...
QUERY_MODEL_NAME="/home/nlp/achimoa/workspace/ModernBERT/hf/HebrewModernBERT/ModernBERT-Hebrew-base_v2"
DOC_MODEL_NAME="/home/nlp/achimoa/workspace/ModernBERT/hf/HebrewModernBERT/ModernBERT-Hebrew-base_v2"
QUERY_FIELD="question_english"
DOCUMENT_FIELD="context_hebrew"
MAX_LENGTH=512
NUM_EPOCHS=10
OUTPUT_DIR="outputs/models/dual_encoder/heq_q_eng_d_heb/hebmodernbert/ModernBERT-Hebrew-base_v2"
