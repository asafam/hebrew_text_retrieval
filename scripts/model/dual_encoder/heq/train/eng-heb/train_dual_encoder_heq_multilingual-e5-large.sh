#!/bin/bash -i
#SBATCH --job-name=dualenc_multilingual-e5-large
#SBATCH --output=logs/slurm/dualenc_multilingual-e5-large_%j.out
#SBATCH --error=logs/slurm/dualenc_multilingual-e5-large_%j.err
...
MAX_LENGTH=512
NUM_EPOCHS=10
OUTPUT_DIR="./outputs/models/dual_encoder/heq_q_eng_d_heb/intfloat_multilingual-e5-large"
