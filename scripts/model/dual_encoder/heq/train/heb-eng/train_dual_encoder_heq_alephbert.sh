#!/bin/bash -i
#SBATCH --job-name=dualenc_alephbert
#SBATCH --output=logs/slurm/dualenc_alephbert_%j.out
#SBATCH --error=logs/slurm/dualenc_alephbert_%j.err
...
MAX_LENGTH=512
NUM_EPOCHS=10
OUTPUT_DIR="./outputs/models/dual_encoder/heq_q_heb_d_eng/onlplab_alephbert-base"
