#!/bin/bash -i
#SBATCH --job-name=dualenc_multilingual-e5-base
#SBATCH --output=logs/slurm/dualenc_multilingual-e5-base_%j.out
#SBATCH --error=logs/slurm/dualenc_multilingual-e5-base_%j.err
...
MAX_LENGTH=512
NUM_EPOCHS=10
OUTPUT_DIR="./outputs/models/dual_encoder/heq_q_heb_d_eng/intfloat_multilingual-e5-base"
