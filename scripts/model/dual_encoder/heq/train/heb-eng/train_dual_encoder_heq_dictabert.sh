#!/bin/bash -i
#SBATCH --job-name=dualenc_dictabert
#SBATCH --output=logs/slurm/dualenc_dictabert_%j.out
#SBATCH --error=logs/slurm/dualenc_dictabert_%j.err
...
MAX_LENGTH=512
NUM_EPOCHS=10
OUTPUT_DIR="./outputs/models/dual_encoder/heq_q_heb_d_eng/dicta-il_dictabert"
