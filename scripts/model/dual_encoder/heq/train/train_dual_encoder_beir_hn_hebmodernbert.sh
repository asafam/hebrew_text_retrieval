#!/bin/bash -i
#SBATCH --job-name=train_hmb_beir_hn
#SBATCH --output=logs/slurm/train_hmb_beir_hn_%j.out
#SBATCH --error=logs/slurm/train_hmb_beir_hn_%j.err
...
OUTPUT_DIR="outputs/models/dual_encoder/cls_pooling/beir_hebrew_hn/hebmodernbert/ModernBERT-Hebrew-base_v2"

echo "Model: $MODEL (with hard negatives)"
