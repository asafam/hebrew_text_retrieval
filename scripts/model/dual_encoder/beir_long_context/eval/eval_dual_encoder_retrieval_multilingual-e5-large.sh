#!/bin/bash -i
#SBATCH --job-name=eval_me5l_beir_lc
#SBATCH --output=logs/slurm/eval_me5l_beir_lc_%j.out
#SBATCH --error=logs/slurm/eval_me5l_beir_lc_%j.err
...
# Zero-shot eval — mE5-large is loaded directly from HuggingFace, no local checkpoint.
...
OUTPUT_DIR="outputs/eval/dual_encoder/beir_long_context/multilingual-e5-large/intfloat_multilingual-e5-large"
K_VALUES="0,1,3,5"
BATCH_SIZE=128
MAX_LENGTH=512
