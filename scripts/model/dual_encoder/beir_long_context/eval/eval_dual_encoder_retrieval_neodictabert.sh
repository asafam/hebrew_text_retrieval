#!/bin/bash -i
#SBATCH --job-name=eval_ndb_beir_lc
#SBATCH --output=logs/slurm/eval_ndb_beir_lc_%j.out
#SBATCH --error=logs/slurm/eval_ndb_beir_lc_%j.err
...
MODEL_PATH="outputs/models/dual_encoder/cls_pooling/beir_hebrew/neodictabert/dicta-il_NeoDictaBERT/model"
TOKENIZER_PATH="dicta-il/neodictabert"
OUTPUT_DIR="outputs/eval/dual_encoder/beir_long_context/neodictabert/dicta-il_NeoDictaBERT"
K_VALUES="0,1,3,5"
BATCH_SIZE=128
MAX_LENGTH=512
