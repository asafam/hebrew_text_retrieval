...
# Define variables
MODEL_PATH="outputs/models/dual_encoder/dual_encoder_infonce_heq/intfloat_multilingual-e5-base/model"
...
BATCH_SIZE=1024
MAX_LENGTH=512
DOCUMENTS_EMBEDDING_FILE="outputs/eval/dual_encoder/dual_encoder_infonce_heq/intfloat_multilingual-e5-base/model/doc_embeddings.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/dual_encoder_infonce_heq/intfloat_multilingual-e5-base/model/results.txt"
