...
BATCH_SIZE=1024
MAX_LENGTH=512
DOCUMENTS_EMBEDDING_FILE="outputs/eval/dual_encoder/dual_encoder_infonce_squad_v2_q_en_d_he/intfloat_multilingual-e5-base_untrained/model/doc_embeddings.pt"
OUTPUT_FILE="outputs/eval/dual_encoder/dual_encoder_infonce_squad_v2_q_en_d_he/intfloat_multilingual-e5-base_untrained/model/results.txt"
